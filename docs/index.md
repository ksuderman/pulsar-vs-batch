...
8 workflow invocations, 98 total jobs. All completed successfully.

## Results Summary

### All Runs

| Runner | Run | Input Sizes | Wall Clock | Compute Time | Scheduling Overhead |
|--------|-----|-------------|-----------|-------------|-------------------|
| batch | 1 | 10GB+2GB+5GB | 527.5 min | 504.3 min | 23.2 min (4%) |
| batch | 1 | 2GB | 205.7 min | 185.7 min | 20.1 min (10%) |
| batch | 1 | 2GB+5GB | 338.5 min | 320.4 min | 18.1 min (5%) |
| batch | 2 | 2GB | 207.6 min | 187.1 min | 20.4 min (10%) |
| batch | 2 | 2GB+5GB | 339.2 min | 320.3 min | 18.9 min (6%) |
| pulsar | 1 | 10GB+2GB+5GB | 622.6 min | 530.4 min | 92.2 min (15%) |
| pulsar | 1 | 2GB | 317.4 min | 238.5 min | 79.0 min (25%) |
| pulsar | 1 | 2GB+5GB | 587.4 min | 482.9 min | 104.5 min (18%) |
...
| picard_MarkDuplicates | 2563s | 464s | -2099s | -82% |
...
| picard_MarkDuplicates | 3 | 0.18x | ~3x |
| samtools_stats | 2 | 0.97x | ~2x |
| lofreq_viterbi | 4 | 0.00x | ~4x |
| multiqc | 1 | 0.00x | ~1x |
| lofreq_indelqual | 1 | 0.00x | ~1x |
| lofreq_call | 2 | 0.00x | ~2x |
| snpEff | 1 | 0.00x | ~1x |
...
- **picard_MarkDuplicates** (10GB+2GB+5GB): -82% (464s vs 2563s)
- **lofreq_viterbi** (10GB+2GB+5GB): -100% (0s vs 1183s)
- **multiqc** (10GB+2GB+5GB): -100% (0s vs 9s)
- **lofreq_indelqual** (10GB+2GB+5GB): -100% (0s vs 652s)
- **lofreq_call** (10GB+2GB+5GB): -100% (0s vs 14609s)
- **snpEff** (10GB+2GB+5GB): -100% (0s vs 7s)
...
- **Inject `GALAXY_SLOTS` into Pulsar task environment.** Tools that read `$GALAXY_SLOTS` for thread count would benefit. A fix has been prototyped in `pulsar/client/container_job_config.py`.
...
- **Pulsar's I/O model has advantages.** Local SSD staging benefits I/O-bound tools. The snpEff_build_gb speedup warrants investigation.
